...
class MultiTurnConfig(BaseConfig):
    ...
    enable: bool = False
    # Enable async step reward requests during multi-turn tool use.
    async_step_reward: bool = False
    ...
    # Custom prompt/tooling hooks (optional; used by user extensions).
    dynamic_prompt: dict = field(default_factory=dict)
    custom_tooling: dict = field(default_factory=dict)
